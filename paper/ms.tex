...
This research utilized the following open-source \python\ packages:
    ...
    \package{astroquery} \citep{Ginsburg:2016},
    \package{ccdproc} \citep{Craig:2015},
    \package{celerite} \citep{Foreman-Mackey:2017},
    \package{corner} \citep{Foreman-Mackey:2016},
